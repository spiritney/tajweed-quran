...
export const load = async () => {
    await getDataAsText()
    await transformSuratTextToPages()
    await combineNormalPages()
};

// rm -fr src/lib/data/quran/pages/* &&   rm -fr src/lib/data/quran/normal-pages/* && rm -fr src/lib/data/quran/text/* && clear && pd